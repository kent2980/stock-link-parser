...
POST_NON_NUMERIC_SUMMARY = "/xbrl/ix/non_numeric_summary/list/"
""" IX_NON_NUMERIC_SUMMARYテーブルに複数データを追加するエンドポイント """
POST_NON_FRACTIONS = "/xbrl/ix/non_fraction/list/"
""" IX_NON_FRACTIONテーブルに複数データを追加するエンドポイント """
POST_NON_FRACTIONS_SUMMARY = "/xbrl/ix/non_fraction_summary/list/"
""" IX_NON_FRACTION_SUMMARYテーブルに複数データを追加するエンドポイント """
...
POST_FILE_PATH = "/xbrl/ix/file_path/list/"
...
""" IX_LOC_HREF_MASTERテーブルにデータを追加するエンドポイント """
POST_LOC_HREF_MASTER = "/xbrl/loc_href_master/list/"
